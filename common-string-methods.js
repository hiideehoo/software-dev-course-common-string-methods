...
let activity1 = "Learning JavaScript is fun!";
console.log(activity1.includes("JavaScript"));
console.log(activity1.indexOf("fun"));

let activity2 = " CODE BOOTCAMP ";
let stringConvert = activity2.toLowerCase().trim();
console.log(stringConvert);
console.log(stringConvert.replace("bootcamp", "JavaScript"));

let activity3 = "Coding is fun and educational";
console.log (activity3.split(" "));

let activity4 = "Bootcamp";
console.log(activity4.charAt(0));
console.log(activity4.slice(4));

let advancedChallenge = `Customer: John Doe
Order: Apple, Banana, Grape
Total: $20.50`;
console.log(advancedChallenge.slice(10, 19));
console.log(advancedChallenge.split(`\n`)); // Not to sure what is meant by "items." Every word? Every line?
console.log(advancedChallenge.toUpperCase()); // I don't think I can convert just the total to uppercase? Unless I use replace, but that doesn't seem like the solution.
